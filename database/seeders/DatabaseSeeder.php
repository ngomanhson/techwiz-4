...
//            ],
        ...
        DB::table('product_review')->insert([
            [
                'product_id' => 1,
                'user_id' => 3,
                'message' => 'Plant arrived healthy and is growing nicely due to clear instructions !',
                'score' => 5,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'product_id' => 1,
                'user_id' => 4,
                'message' => 'The second plant arrived perfectly and is really pretty !',
                'score' => 4,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                'product_id' => 2,
                'user_id' => 5,
                'message' => 'My tree arrived healthy, well packaged, and just as pictured !',
                'score' => 5,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'product_id' => 6,
                'user_id' => 6,
                'message' => 'The tree is doing fine, but when I received it the pot was wedged almost sideways and the tree lost a bit of one of its branches from impacting the side of the box.',
                'score' => 2,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'product_id' => 4,
                'user_id' => 4,
                'message' => 'This was a replacement plant. The first one was very small. I appreciate that they were willing to send send a new plant.',
                'score' => 4,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'product_id' => 20,
                'user_id' => 4,
                'message' => 'This was the perfect house warming gift!',
                'score' => 5,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'product_id' => 17,
                'user_id' => 7,
                'message' => 'Came in perfect condition',
                'score' => 4,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'product_id' => 12,
                'user_id' => 5,
                'message' => 'Customer service was above and deuyond what I exceeded. Plant was delivered damaged and was replaced with a beautiful new plant. ',
                'score' => 5,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'product_id' => 12,
                'user_id' => 3,
                'message' => 'Adorable Plant, However the plant is small but the pit it’s in is tiny',
                'score' => 3,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                'product_id' => 18,
                'user_id' => 6,
                'message' => 'I am so impressed with the way in which my plant was packed and shipped!',
                'score' => 5,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'product_id' => 25,
                'user_id' => 6,
                'message' => 'No instructions on how to charge the mister.',
                'score' => 3,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                'product_id' => 24,
                'user_id' => 5,
                'message' => 'I am new to Bloomscape so hoping the fertilizer will work great. ',
                'score' => 5,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'product_id' => 27,
                'user_id' => 7,
                'message' => 'Arrived well packaged and the plant was in great condition. Thank you!',
                'score' => 4,
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ...
        DB::table('users')->insert([
            ...
            [
                'id' => 5,
                'first_name' => 'Trinh Van ',
                'last_name' => 'Trung',
                'email' => 'trinhvantrung@gmail.com',
                'password' => Hash::make('12345678'),
                'level' => 2,
                'description' => null,
                'company_name'=> 'FPT APTECH',
