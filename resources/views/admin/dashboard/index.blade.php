                                            ...
                                            <div class="list-group-item">
                                                <div class="row align-items-center">
                                                    <div class="col-3 col-md-2">
                                                        <img src="{{ isset($productFeatured->product->productImages[0]) ? $productFeatured->product->productImages[0]->path : 'hhhh.jpg' }}" alt="{{ $productFeatured->product->name }}" class="img-thumbnail" style="width: 50px; height: 50px; object-fit: cover">
                                                    </div>
                                                    <div class="col">
